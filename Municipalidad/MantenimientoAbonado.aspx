<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MantenimientoAbonado.aspx.cs" Inherits="Municipalidad.MantenimientoAbonado" %>
...
<body style="background-image:url(http://www.hdfondos.eu/pictures/2012/0802/1/abstract-minimalistic-trees-grey-1680x1050-wallpaper-569251.jpg)">
    <form id="form1" runat="server">
        ...
        <p class="auto-style2">
            &nbsp;</p>
        <p class="auto-style3">
            Escriba el nombre del abonado a modificar y el docId que desea modificar:</p>
