...
namespace Municipalidad
{
    public partial class Administrador : System.Web.UI.Page
    {
        ...
        protected void guardarDatos(string idMunicipalidad)
        {
            ...
            comando.CommandText = "sp_validarEntradaMunicipalidad";
            comando.CommandType = CommandType.StoredProcedure;
            comando.Parameters.AddWithValue("@idMunicipalidad", idMunicipalidad);
            try
            {
                conexion.Open();
                ...
                Response.Redirect("OpcionesAdministrador.aspx?Valor=" + Valor);
